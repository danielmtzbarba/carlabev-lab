#!/bin/bash
#SBATCH --job-name=carlabev_diff_tf_rerun
#SBATCH --output=results/logs/difficulty_temporal_fusion_rerun_%A_%a.out
#SBATCH --error=results/logs/difficulty_temporal_fusion_rerun_%A_%a.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
echo "Starting rerun for missing difficulty/temporal-fusion trial on node: $(hostname)"
