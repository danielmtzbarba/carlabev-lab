#!/bin/bash
#SBATCH --job-name=carlabev_optuna_phase2a
#SBATCH --output=results/logs/phase2a_%A_%a.out
#SBATCH --error=results/logs/phase2a_%A_%a.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
echo "Starting Optuna Phase 2a worker on node: $(hostname)"
...
# Run the Optuna Tuner Phase 2a using uv
