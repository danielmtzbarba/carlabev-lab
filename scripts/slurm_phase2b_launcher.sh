#!/bin/bash
#SBATCH --job-name=carlabev_optuna_phase2b
#SBATCH --output=results/logs/phase2b_%A_%a.out
#SBATCH --error=results/logs/phase2b_%A_%a.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
echo "Starting Optuna Phase 2b worker on node: $(hostname)"
...
# Run the Optuna Tuner Phase 2b using uv
