...
#SBATCH --output=/data/horse/ws/dama898h-carlabev/results/logs/difficulty_1m_%A_%a.out
#SBATCH --error=/data/horse/ws/dama898h-carlabev/results/logs/difficulty_1m_%A_%a.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
